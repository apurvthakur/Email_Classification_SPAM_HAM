...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  8 02:39:12 2019
...
#Making a WordCloud of SPAM & HAM DATA
filtered_spam_data = ''
filtered_ham_data = ''
...
#Creating Training and Test Dataset and converting string data to integer
from sklearn.feature_extraction.text import CountVectorizer
from sklearn.preprocessing import LabelEncoder
...
#Predicting Output using various Classification model along with Confusion matrix and their accuracy
...
with warnings.catch_warnings():
    ...
    #     Y_test.reshape(Y_test.shape[0])
        ...
        #Predicting Result of Test Dataset
